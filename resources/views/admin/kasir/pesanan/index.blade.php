...
@section('content')
    <div class="w-full flex flex-col justify-center items-center ">
        ...
        <div class="w-full flex flex-col items-center mt-5">
            <div class="filter m-0 flex justify-between items-center flex-row w-full">
            ...
            <table class="min-w-full text-center text-sm font-light">
                ...
                <tbody class="">
                        ...
                        <tr class="{{ $index % 2 === 0 ? 'even:bg-white' : 'odd:bg-slate-50' }}">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 border ">
                                <div class="h-full flex flex-row gap-5 items-center justify-center">
                                    <a href="{{ route('kasir.details', $akun->no_nota) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="whitespace-nowrap px-6 py-4 border text-center">Data belum
                                ada.</td>
                        </tr>
                    @endforelse
                </tbody>
