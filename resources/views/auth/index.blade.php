                ...
                <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                    ...
                    <form action="/auth" method="POST">
                        ...
                        <div class="flex flex-row items-center justify-center lg:justify-start">
                            {{-- <p class="mb-0 mx-auto text-4xl font-bold">LOGIN</p> --}}
                            <p class="mb-0 sm:-mb-4 mr-4 text-2xl font-semibold">Sign in</p>
                        ...
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            <input type="text"
                                ...
                                id="exampleFormControlInput2 username" placeholder="Username" value="{{ old('username') }}"
                        ...
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            <input type="password"
                                class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                id="exampleFormControlInput22" placeholder="Password" name="password" required />
                        ...
                        <div class="mb-6 flex items-center justify-between sm:gap-0 gap-5">
