...
@section('content')
    <div class="w-full flex flex-col justify-center items-center ">
        ...
        @endif
        {{-- Todo Title --}}
        <p class="w-full text-center border-b-2 border-slate-400 text-xl font-semibold text-neutral-800">Manage
            Menu</p>
        {{-- Todo Create --}}
        ...
        <div class="w-full flex flex-row justify-between items-center">
            <div class="flex flex-row gap-3">
                ...
                <button type="button"
                    ...
                    data-te-toggle="modal" data-te-target="#exampleModal1" data-te-ripple-init data-te-ripple-color="light">
                    Create Kategory
                </button>
            </div>
        ...
        <div data-te-modal-init
            ...
            <div data-te-modal-dialog-ref
                ...
                <div
                    ...
                    <!--Modal body-->
                    <form action="{{ route('manager.menu') }}" method="post" class="flex flex-col gap-1"
                        enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <input type="text" value="menu" name="tipe" class="hidden">
                ...
                <div data-te-modal-dialog-ref
                    ...
                    <div
                        ...
                        <form action="{{ route('manager.menu') }}" method="post" class="flex flex-col gap-1"
                            ...
                            <div class="relative flex-auto p-4" data-te-modal-body-ref>
                                <div class="relative mb-3" data-te-input-wrapper-init>
                                    <input type="text" value="kategori" readonly class="hidden" name="tipe">
                                    <input type="text"
                                        class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                        id="exampleFormControlInput2" placeholder="Form control lg" required autofocus
                                        name="nama" />
                    ...
                    <table class="min-w-full text-center text-sm font-light">
                        ...
                        <tbody class="">
                            @forelse ($menus as $menu)
                                @php
                                    $index = $menus->firstItem() + $loop->index;
                                @endphp
                                {{-- {{ $menu }} --}}
                                <tr class="{{ $index % 2 === 0 ? 'even:bg-white' : 'odd:bg-slate-50' }}">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 border">Rp
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4 border">
                                        <div class="h-full flex flex-row gap-5 items-center justify-center">
                                            ...
                                            <a href="{{ route('manager.menu.edit', $menu->id) }}"
